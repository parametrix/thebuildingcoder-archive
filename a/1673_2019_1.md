...
It is pretty easy if you have been following the discussion on Forge Design Automation for Revit *(link unavailable)* at all.
...
an [`ElementParameterFilter` with a shared parameter](0423_filter_shared_param.htm).
...
his [comment on that post](0423_filter_shared_param.htm#comment-4044857725):
