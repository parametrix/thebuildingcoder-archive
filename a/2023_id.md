...
- Element Id
    - [Retrieving Newly Created Elements in Revit 2011](0344_mirror_new_elements.htm)
    - [Comparing Element Id for Equality](0544_element_id_equality.htm)
    - [DWG Issues and Various Other Updates](0948_dwg_issues.htm)
    - [Element Id &ndash; Export, Unique, Navisworks and Other Ids](1144_nw_unique_id.htm)
    - [CreateLinkReference Sample Code](1182_createlinkreference.htm)
    - [Family Category, Element Ids, Transaction Undo and Updates](1353_fam_cat_elem_transact.html)
    - [DevDay Conference in Munich and WPF DoEvents](1396_devday_wpf_doevents.html)
    - [Revit versus Forge, Ids and Add-In Installation](1577_forge_ids_install.html)
    - [Retrieving Newly Created Element Ids](1628_get_new_element_ids.html)
    - [RevitLookup Search by Element and Unique Id](1634_lookup_search_snoop.html)
    - [Element Identifiers in RVT, IFC, NW and Forge](1762_forge_rvt_nw_ifc_id.html)
    - [Immutable UniqueId and Revit Database Explorer](1959_rdbe.html)
    - [64-Bit Element Ids, Maybe?](1974_64_bit_element_id.html)
    - [Configuring RvtSamples 2024 and Big Numbers](1992_rvtsamples2024.html)
    - [64 Bit Ids, Revit and RevitLookup Updates](1995_lookup.html)
- UniqueId
    - [UniqueId, DWF and IFC GUID](0104_uniqueid_dwf_ifc_guid.htm)
    - [Melbourne Day Two](0737_melbourne_day_2.htm)
    - [Real-World Concrete Corner Coordinates](0787_real_world_corners.htm)
    - [IFC GUID Generation and Uniqueness](0819_ifc_guid.htm)
    - [Copy and Paste API Applications and Modeless Assertion](0943_duplicate_views.htm)
    - [Element Id &ndash; Export, Unique, Navisworks and Other Ids](1144_nw_unique_id.htm)
    - [Unique Names and the NamingUtils Class](1209_namingutils.htm)
    - [Understanding the Use of the UniqueId](1277_uniqueid.htm)
    - [Back from Easter Holidays and Various Revit API Issues](1304_back_from_easter.htm)
    - [Consistency of IFC GUID and UniqueId](1459_ifc_guid_uniqueid.html)
    - [Revit versus Forge, Ids and Add-In Installation](1577_forge_ids_install.html)
    - [RevitLookup Search by Element and Unique Id](1634_lookup_search_snoop.html)
    - [Unique Id and IFC GUID Parameter](1949_unique_ifc_guid.html)
    - [Immutable UniqueId and Revit Database Explorer](1959_rdbe.html)
