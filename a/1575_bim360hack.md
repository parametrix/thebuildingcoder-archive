...
the [BIM 360 online hackathon](1574_cloud_dock_events.html#3) and 
an introductory [integration and partnering webinar recording](1574_cloud_dock_events.html#3b).
...
a method to [get the entire model extents](1456_bounding_section_box.html#8).
...
- [LINQ DIY Transformed Geometry Bounding Box](1035_geo_bound_box.htm)
