...
which [entered public beta](1718_da4r_beta.html) just last week.
...
in [linking in an IFC file programmatically](1719_link_in_ifc.html#3)
...
- [Exporting room boundaries to CSV](1713_room_boundary_wpf.html)
- [Retrieving linked `IfcZone` elements using Python](1715_list_ifc_zones_py.html)
- [Linking in and analysing IFC file zones and spaces](1719_link_in_ifc.html)
