...
- [New Revit 2020 SDK samples](1744_2020_sdk_samples.html)

I now turn to the migration of 
my C# and VB Visual Studio Revit add-in wizards *(link unavailable)* to
...
the [migration of the much more complex Building Coder samples](1741_rvtsamp_zero_close.html#3) required
...
the Revit API beginners material *(link unavailable)*,
...
the [importance of understanding Revit and the BIM from an end user point of view](1661_rename_family.html#2) before
...
to [research how to solve your task programmatically](1515_repro_tray_conduit.html#3).
