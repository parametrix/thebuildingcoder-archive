...
- [RayTraceBounce Pool Table](0273_raytracebounce_pool_table.htm)
- [Rectangular Duct Corners](0285_rectangular_duct_corners.htm)
- [Spot Elevation Creation on Top of Beam](0293_spot_elevation_at_beam_top.htm)
...
on [determining the face tangent at a picked point by generic face tangent determination](1282_face_point_tangent.htm#4).
...
API Dynamic Model Updater framework DMU *(link unavailable)*.

Look specifically at
the [Associative Section View SDK sample](0624_assoc_sect_view.htm#2) for
...
and [other database exploration tools](1057_db_explor_python_sh.htm).
