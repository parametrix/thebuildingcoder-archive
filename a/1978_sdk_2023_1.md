...
still [setting up my new Mac PC](1976_chatgpt_arm_tsp.html#11):
...
the [VS wizard template location](1967_addins.html#6) last
time I tried.
...
on the [journal files AU class](1977_cultureinfochanger.html#4).
