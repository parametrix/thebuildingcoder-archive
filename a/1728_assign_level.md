...
to [link in and analyse IFC file zones and spaces](1719_link_in_ifc.html),
then [prepared it for use in Forge Design Automation](1720_prepare_da4r.html).
...
to [retrieve levels sorted by elevation](1246_webgl_sorted_level.htm#3).
